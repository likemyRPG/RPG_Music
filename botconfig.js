module.exports = {
  Admins: ["295284210820841472", "267298628262035459"], //Admins of the bot
  ...
  Presence: {
    ...
    name: `${Prefix}help | ${client.guilds.cache.size} Guilds | ${Math.ceil(client.users.cache.size/1000)}k Members`, // The message shown
